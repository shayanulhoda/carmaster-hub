...
export function BrandOwnerForm({ onSuccess }: BrandOwnerFormProps) {
  ...
  const onSubmit = async (data: BrandOwnerFormValues) => {
    console.log("Brand Owner data:", data);
    toast.success("Brand Owner added successfully. KYC status: Pending Review");
    form.reset();
    onSuccess();
  };
